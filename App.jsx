...
import { BorderAll, Height, Rowing } from '@mui/icons-material';
  ...
  return (
    ...
    <div>
      ...
      <div>
        ...
        <tr  >
        <td  className='para '>1. Essential Cookies</td><td className='para'>Essential cookies (First Party Cookies) are sometimes called “strictly necessary” as without them we cannot provide many services that you need on the Website. For example, essential cookies help remember your preferences as you move around the Website. Essential cookies also keep you logged in into a website. Without them the login functionality would not work. </td> </tr>
        <tr >
          <td className='para'>2.Analytics Cookies</td><td className='para'>These cookies track information about visits to the 99acres.com and partner websites so that we can make improvements and report our performance. For example: analyse visitor and user behaviour so as to provide more relevant content or suggest certain activities. They collect information about how visitors use the Websites, which site the user came from, the number of each user’s visits and how long a user stays on the Websites. We might also use analytics cookies to test new ads, pages, or features to see how users react to them.
        ...
        <tr  >
          <td className='para'>3. Functionality or Preference Cookies</td><td className='para'>
        ...
        <tr >
        <td className='para'>4.Targeting or Advertising Cookies </td><td className='para'>
        These Cookies are placed by third party advertising platforms or networks or 99acres.com in order to, deliver ads and track ad performance, enable advertising networks to deliver ads that may be relevant to you based upon your activities (this is sometimes called “behavioural” “tracking” or “targeted” advertising) on the Websites. They may subsequently use information about your visit to target you with advertising that you may be interested in, on 99acres.com websites or other websites. For example, these cookies remember which browsers have visited the websites.
        </td>
        </tr>
        </table><br></br>
      </div>
        ...
        <div className='para'>
        Most browsers allow you to control cookies through their settings preferences. However, if you choose to turn off these cookies, you will still see advertising on the internet but it may not be tailored to your interests. It does not mean that you won't be served any advertisements whilst you are online. Whilst we have mentioned most of the third parties involved in using targeting or advertising cookies in the preceding <span className=''>section</span>, the list is not exhaustive and is subject to change. Therefore, even if you choose to turn off all the third party cookies listed in <span  className=''>section</span> , you may still receive some tailored advertisements and recommendations.
        </div>
       <div className='para'>
      ...
      <div className='para'>
        ...
        The browser settings for changing your cookies settings are usually found in the 'options' or 'preferences' menu of your internet browser. In order to understand these settings, the following links may be helpful. Otherwise you should use the 'Help' option in your internet browser for more details.
          ...
          <ul>
         <li> <a  className='link2' href='https://support.microsoft.com/en-us/windows/delete-and-manage-cookies-168dab11-0753-043d-7c16-ede5947fc64d'>.Cookie settings in Internet Explorer </a></li>
          
          
          <li><a className='link2' href='https://support.mozilla.org/en-US/kb/enhanced-tracking-protection-firefox-desktop?redirectslug=enable-and-disable-cookies-website-preferences&redirectlocale=en-US'>.Cookies settings in Firefox </a></li>
          
          
          <li><a className='link2' href='https://support.google.com/chrome/answer/95647'>.Cookies settings in Chrome</a></li>
          
          
          <li><a className='link2' href='https://support.apple.com/kb/ph21411?locale=en_GB'>.Cookies settings in Safari</a></li>
          </ul>
          <div>
