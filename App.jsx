  ...
  return (
    ...
    <div>
      ...
      <div className='para'>
        ...
        <div className=''>
          <div>
          <a  className='link2' href='https://support.microsoft.com/en-us/windows/delete-and-manage-cookies-168dab11-0753-043d-7c16-ede5947fc64d'>.Cookie settings in Internet Explorer </a>
          </div>
          <div >
          <a className='link2' href='https://support.mozilla.org/en-US/kb/enhanced-tracking-protection-firefox-desktop?redirectslug=enable-and-disable-cookies-website-preferences&redirectlocale=en-US'>.Cookies settings in Firefox </a>
          </div>
          <div >
          <a className='link2' href='https://support.google.com/chrome/answer/95647'>.Cookies settings in Chrome</a>
          </div>
          <div >
          <a className='link2' href='https://support.apple.com/kb/ph21411?locale=en_GB'>.Cookies settings in Safari</a>
          </div>
          <div>
